<#list conditionList as a><#if a_index%3=2>
...
<#list columnList as a><#if a.order><#assign order=true/><#break/></#if></#list>
				<#if order??&&order>handler.getString("orderField"), handler.getString("orderType"), </#if>handler.getInteger("pageNo",1), handler.getInteger("count",20)