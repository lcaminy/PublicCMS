...
public class CmsSiteUserListDirective extends BaseDirective {
	...
	public void execute(DirectiveHandler handler) throws TemplateException, IOException {
		PageHandler page = service.getPage(handler.getInteger("siteId"), handler.getInteger("userId"), handler.getBoolean("isAdmin"), handler.getBoolean("isDisable"),  handler.getPageNo(), handler.getCount());
		handler.render(page);
	}
