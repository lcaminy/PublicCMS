...
public class CmsModelExtendListDirective extends BaseDirective {
	...
	public void execute(DirectiveHandler handler) throws TemplateException, IOException {
		PageHandler page = service.getPage(handler.getInteger("modelId"), handler.getInteger("extendType"), handler.getShort("type"), handler.getInteger("pageNo",1), handler.getInteger("count",20));
