...
@Controller
@RequestMapping("logEmailCheck")
public class LogEmailCheckController extends BaseController {
	@Autowired
	private LogEmailCheckService service;

	@RequestMapping(value = { "save" + DO_SUFFIX })
	public String save(LogEmailCheck entity, HttpServletRequest request) {
